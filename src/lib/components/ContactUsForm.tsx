...
export function ContactUs() {
  ...
  return (
    <div className={classes.wrapper}>
      ...
      >
        <div>
          <Title className={classes.title}>Liên hệ đặt hàng</Title>
          <Text className={classes.description} mt="sm" mb={30}>
            Để lại email và số điện thoại, chúng tôi sẽ liên hệ trong vòng 24
            giờ.
          </Text>
        ...
        <div className={classes.form}>
          ...
          <Textarea
            required
            label="Lời nhắn"
            placeholder="Tôi muốn đặt mua sản phẩm,..."
            minRows={4}
            mt="md"
            classNames={{ input: classes.input, label: classes.inputLabel }}
          />
